 ...
 * Contiene los datos que se utilizarán para poblar la base de datos al ejecutar el seed
 * @author fredy_vazzqz
 * @version 1.0.0
 */
...
export const initialData: SeedData = {
    ...
    users: [
        {
            email: 'fred_15@outlook.com',
            fullName: 'freddy vazquez',
            password: 'Abc123',
            roles: ['admin', 'user']
        },
        {
            email: 'mario_15@outlook.com',
            fullName: 'mario vazquez',
            password: 'Abc123',
            roles: ['user']
        }
    ]
